    ...
    <div class="scrolling-wrapper">
        ...
        <a href = "./sp-marching-squares.html">
            <div class="canvas">
                ...
                <div id="card">
                    <div id="box">
                        <img src='entrypoints/assets/gamelogo3y.PNG' class="card-img" alt="gameLogo1">    
                        <h2>Marching Squares</h2>
                    </div>
                    <div id="extra-card-logos">
                        <img src = 'entrypoints/assets/logos/unity-logo-extrawhite.png' alt="unityLogo" width="64px">
                    </div>
        ...
        <section class="c-hidden d2">
            ...
            <div class="canvas">
                ...
                <div class="tracker tr-25"></div>
                    <div id="card">
                        <div id="box">
                            <img src='entrypoints/assets/coppertest2.png' class="card-img-no-width" alt="gameLogo2" width="100%">
                            <h2>I Can't Stop!</h2>
                        </div>
                        <div id="extra-card-logos">
                            <img src = 'entrypoints/assets/logos/gamemaker-logo.png' alt="gmLogo" width="64px">
                        </div>
                        <div id="extra-card"> 
        ...
        <div class="container noselect">
         ...
         <a href = "https://github.com/stopbreaking/RPG-TESTX">
            <div class="canvas">
                ...
                <div id="card">
                    <div id="box">
                        <img src="entrypoints/assets/f.PNG" class="card-img" alt="gamelogo1">
                        <h2>Rpg Test</h2>
                    </div>
